...
execute: 
  echo: false
bibliography: [r-references.bib, wolff_etal_2022.bib]
csl: "wolff_etal_2022b.csl"
---
...
#| fig-cap: "Preference for individual stooge birds per subject bird for replicates 1 and 2. Squares represent a subject/stooge pairing, and the color illustrates the percentage of times the group including that stooge was chosen by that subject. Blue represents a preference *for* a particular stooge, green represents a preference *against* a particular stooge,  and white represents no preference. Asterisks note female subjects and stooges."
#| out-width: "100%"
